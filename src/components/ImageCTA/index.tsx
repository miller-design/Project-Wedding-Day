	...
	return (
		<section className="[ TooImageCTA ][ col-span-full ][ too-col ]">
			<div className={"[ too-grid-inner items-center ]"}>
				...
				<div className="[ relative ][ too-col justify-center items-center ][ col-span-full sm:col-start-2 sm:col-end-12 md:col-start-3 md:col-end-11 xxl:col-start-5 xxl:col-end-9 row-start-1 row-end-1 ][ text-white text-center text-balance ]">
